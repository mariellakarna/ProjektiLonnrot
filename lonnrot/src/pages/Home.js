  ...
  return (
    <div className="home">
      <div className="headerContainer">
        <h3>Tavoite</h3>
        <p> Elias Lönnrot keräsi kansanrunoutta jälkipolville, me keräämme ja pelastamme tulevaisuudelle
...
Projekti Gutenbergin kanssa.</p>
        <h3>Miten toimitaan</h3>
        <p>Sähkökirjojen valmistus tapahtuu vapaaehtoisvoimin sekä etupäässä offline-työnä että oikoluvun osalta myös vain vähän
...
sekä tekijänoikeuksien sallimissa puitteissa eri puolilla maailmaa oleville Project Gutenbergin palvelimille.</p>
      </div>
      <h3>Valmiit e-kirjat</h3>
      <p>Kirjailijoiden ja heidän kirjansa sivulta voit nähdä kunkin kirjailijan valmiiden teosten luettelon lähtemällä kirjailijoiden
...
Jos mielikirjaasi ei löydy kokoelmistamme ja se on copyright-vapaa, niin tee ehdotus kirjan tuottamisesta y.o. palaute-linkin kautta.</p>
      <h3>Yhteydenotto</h3>
      <p>Yhteydenotto käy sähköpostitse.
      Samalla voit miettiä, miten mahdollisesti voisit osallistua oikolukuun tai kulttuurityömme tukemiseen.</p>
    </div>
  )
}
